...
conversion = bitcoin_data["bpi"]["USD"]["rate_float"]
worth = conversion * bitcoin
puts "1 Bitcoin is worth $" + bitcoin_data["bpi"]["USD"]["rate"]
puts "Your Bitcoin is worth $" + worth.to_s